...
def user_to_blockchain(json_data):
    print ("user_to_blockchain:")
    print(json.dumps(json_data, sort_keys=True, indent=4, separators=(', ', ': ')))
    r = requests.post("http://" + BLOCKCHAIN_SERVER + ":5555/set_info", json=json_data)
    return r;
